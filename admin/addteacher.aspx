<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MasterAdmin.master" AutoEventWireup="true" CodeFile="addteacher.aspx.cs" Inherits="admin_addteacher" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
     <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Add Teacher Profile</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
                    ...
                    <div class="panel-body">
                        <div class="flot-chart">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <asp:TextBox ID="email" runat="server" name="email" placeholder="email address" class="form-control"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Enter email address" ControlToValidate="email" CssClass="text-danger"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            ...
                            <div class="clearfix">&nbsp;</div>
                            <div class="form-group">
                                <label class="control-label col-sm-3" for="school">Qualification :</label>
                                <div class="col-sm-9">
                                    <asp:TextBox ID="qualification" runat="server" name="school" placeholder="Qualification" class="form-control"></asp:TextBox>
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ErrorMessage="Enter Qualification" ControlToValidate="qualification" CssClass="text-danger"></asp:RequiredFieldValidator>
                                </div>
                            </div>
                            <div class="clearfix">&nbsp;</div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="col-sm-offset-3 col-sm-9">
                                    <asp:Button ID="addteacher" runat="server" Text="Add Teacher" CssClass="btn btn-primary" OnClick="addteacher_Click" />
                                </div>
                            </div>
