<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MasterAdmin.master" AutoEventWireup="true" CodeFile="deleteteacher.aspx.cs" Inherits="admin_deleteteacher" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Delete Teacher's Account</h1>
            </div>
            <!-- /.col-lg-12 -->
        </div>
        <!-- /.row -->
            ...
            <div class="col-lg-9 col-lg-offset-1">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        Are you Want to Delete the Selected Account
                    </div>
                    <!-- /.panel-heading -->
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-9">
                                <asp:Button ID="deleteteacher" runat="server" Text="Delete Teacher" CssClass="btn btn-primary" OnClick="deleteteacher_Click"/>
                            </div>
                        </div>
