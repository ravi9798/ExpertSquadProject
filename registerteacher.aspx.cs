    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (captchaCode.Text.ToLower() == Session["sessionCaptcha"].ToString())
        {
            ...
            else
            {
                ...
                string insertCmd = "insert into [registrationteacher](first_name,last_name,email,password,mobile,photo,gender,qualification,address,activation_code,is_active,created_on) values(@first_name,@last_name,@email,@password,@mobile,@photo,@gender,@qualification,@address,@activation_code,@is_active,@created_on)";
                ...
                insertUser.Parameters.AddWithValue("@qualification", qualification.Text);
                ...
                try
                {
                    ...
                    emailBody += "<p><a href='" + "http://expertsquad.nslcomp.org/ActivateAccountteacher.aspx?activation_code=" + activation_code + "&email=" + Base64Encode(email.Text.Trim()) + "'>Click here to activate your account.</a></p>";
