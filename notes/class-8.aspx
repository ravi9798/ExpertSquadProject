<%@ Page Title="" Language="C#" MasterPageFile="~/notes/notes.master" AutoEventWireup="true" CodeFile="class-8.aspx.cs" Inherits="notes_class_8" %>
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb breadcrumb-padding">
        ...
        <li class="breadcrumb-item active" aria-current="page">Class-8</li>
    </ol>
</nav>
<!-- //about page breadcrumns -->
        ...
        <div class="contact1-bg section-gap">
            <div class="container">
                <div class="col-lg-8 offset-lg-2 col-md-12 col-sm-12 px-lg-3 px-0">
                    <h4 class="section-title">Class - 8  Notes.</h4>
