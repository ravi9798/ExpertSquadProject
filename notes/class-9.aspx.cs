...
public partial class notes_class_9 : System.Web.UI.Page
{
    ...
    public void bind1()
    {
        ...
        con.Open();
        String cmd = "select * from [pdfnotes] where class_name = 'Class-9' and subject_name = 'Biology'";
    ...
    public void bind2()
    {
        ...
        con.Open();
        String cmd2 = "select * from [pdfnotes] where class_name = 'Class-9' and subject_name = 'Chemistry'";
    ...
    public void bind3()
    {
        ...
        con.Open();
        String cmd3 = "select * from [pdfnotes] where class_name = 'Class-9' and subject_name = 'Maths'";
    ...
    public void bind4()
    {
        ...
        con.Open();
        String cmd4 = "select * from [pdfnotes] where class_name = 'Class-9' and subject_name = 'Physics'";
