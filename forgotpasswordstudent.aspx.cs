    ...
    protected void MySubmit_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            try
            {
                ...
                emailBody += "<p><a href = '" + "http://expertsquad.nslcomp.org/resetPasswordstudent.aspx?forgot_otp=" + forgot_otp + "&email=" + Base64Encode(email.Text.Trim()) + "'>Click here to reset password link.</a></p>";
            ...
            {
                lblMsgReg.Text = "something going wrong. contact our developer team!!!";
                lblMsgReg.ForeColor = System.Drawing.Color.Red;
            }
            finally
            {
