...
public partial class activateaccountstudent : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (read.Read())
        {
            ...
            try
            {
                ...
                emailBody += "<p>&nbsp;</p><p style='font-family:Arial,Helvetica,Verdana,sans-serif; font-size:14px;line-height:22px;margin:0px'>If you have any additional queries, please feel free to reach out us at expertsquad.nslcomp.org or drop us an email at <a href='mailto:expertsquad4you@gmail.com' style='text-decoration:none;font-style:normal;font-variant:normal;font-weight:normal;font-family:Arial,Helvetica,Verdana,sans-serif; font-size:14px;line-height:normal;color:rgb(162,49,35)' target='_blank'>expertsquad4you@gmail.com</a>. We are here to help you.</p>";
                emailBody += "<p>&nbsp;</p>";
               ...
               // smtp details for sending registration email 
                ...
                //smtp.Port = 25;
                //smtp.Credentials = new System.Net.NetworkCredential("expertsquad@gmail.com", "password");
                //smtp.Send(mail);
