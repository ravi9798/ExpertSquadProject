<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="registerstudent.aspx.cs" Inherits="registerstudent" %>
    ...
    <div class="container">
        <div class="row">
            ...
            <h2 class="new1">
                ...
                As A Student</h2>
            <hr class="new2" />
            <h3 class="new1">Be an Expert with ExpertSquad.</h3>
            <hr class="new3" />
            <hr class="new1" />
            <div class="col-md-4 col-md-offset-4">
                ...
                <br />
                <div class="form-group">
                    <h5 >Enter Your School :</h5>
                    <asp:TextBox ID="school" runat="server" class="form-control" placeholder="Enter Your School/College"></asp:TextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator10" Forecolor="Red"  runat="server" ErrorMessage="School/College is Requrired!!!" ControlToValidate="school"></asp:RequiredFieldValidator>
                </div>
                <div class="form-group">
